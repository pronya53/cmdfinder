const translations = {
    ru: {
        ...
        pointNames: {
            udachne: {
                1: "Торговая Площадь", 2: "Заправка", 3: "Карго", 4: "Ж/Д Станция", 5: "Резервный Двор", 6: "Ферма", 7: "Школа", 8: "Завод", 9: "Военная База", 10: "Стройка", 11: "Складской Комплекс"
            },
            sergeevka: {
                1: "Окопы", 2: "Западный Аванпост", 3: "Восточный Аванпост", 4: "Завод", 5: "Колхоз", 6: "Заправка", 7: "Опорный Пункт", 8: "Ферма", 9: "Ж/Д Станция", 10: "Школа", 11: "Стройплощадка", 12: "Склады"
            }
        }
    },
    uk: {
        ...
        layerOptions: {
            udachne: 'Удачне', sergeevka: 'Сергеївка', satellite: 'Донецький Аеропорт', DonAirConflict: 'Донецький Аэропорт'
        },
        gridToggleLabel: 'Показати сітку',
        languageLabel: 'Мова:',
        languageOptions: {
            ru: 'російська', uk: 'Українська', en: 'English'
        },
        ...
        themeLabel: "Тема",
        themes: {
            darkgreen: 'Темна + Зелений', lightgreen: 'Світла + Зелений', darkred: 'Темна + Червоний', lightred: 'Світла + Червоний'
        },
        ...
        pointNames: {
            udachne: {
                1: "Торгова Площа", 2: "Заправка", 3: "Карго", 4: "Рейвей стейшн", 5: "Резервний двір", 6: "Ферма", 7: "Школа", 8: "Завод", 9: "Мілітари", 10: "Стройка", 11: "Складский комплекс"
            },
            sergeevka: {
                1: "Окопи", 2: "Західний граничний аванпост", 3: "Східний граничний аванпост", 4: "Завод", 5: "Колгосп", 6: "Заправка", 7: "Опорний пункт", 8: "Ферма", 9: "Залізнична станція", 10: "Школа", 11: "Буд. Майданчик", 12: "Склади"
            }
        }
    },
    en: {
        ...
        layerOptions: {
            udachne: 'Udachne', sergeevka: 'Sergeevka', satellite: 'Donetsk Airport', DonAirConflict: 'Donetsk Airport'
        },
        ...
        themeLabel: "Theme",
        themes: {
            darkgreen: 'Dark + Green', lightgreen: 'Light + Green', darkred: 'Dark + Red', lightred: 'Light + Red'
        },
        ...
        pointNames: {
            udachne: {
                1: "Trade Square", 2: "Gas Station", 3: "Cargo", 4: "Railway Station", 5: "Reserve Yard", 6: "Farm", 7: "School", 8: "Factory", 9: "Military Base", 10: "Construction Site", 11: "Warehouse Complex"
            },
            sergeevka: {
                1: "Trenches", 2: "Western Outpost", 3: "Eastern Outpost", 4: "Factory", 5: "Kolkhoz", 6: "Gas Station", 7: "Strongpoint", 8: "Farm", 9: "Railway Station", 10: "School", 11: "Construction Site", 12: "Warehouses"
            }
        }
    }
};
